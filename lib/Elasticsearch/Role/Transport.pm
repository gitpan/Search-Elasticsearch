...
$Elasticsearch::Role::Transport::VERSION = '1.02';
use Moo::Role;
...
Elasticsearch::Role::Transport - Transport role providing interface between the client class and the Elasticsearch cluster
